<?php 
  ...
  if(isset($_GET['id'])){
    ...
    from tb_bookinfo book join tb_booktype bt on book.typeId=bt.id where book.typeId=$id");
  }
  ...
  if(isset($_POST['page'])&&isRightPage($_POST['page'],$page_nums)){
    $page=$_POST['page'];
    echo "<script language='javascript'>window.open('book_list_type.php?id=$id&page=$page','_self');</script>";
  }
?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<body onLoad="scrollTo(0,0)">
  ...
  <nav class="text-center">
    <ul class="pagination">
      <li><a href="book_list_type.php?<?php
      echo "id=".$id."&"."page=1";
      ?>">首页</a></li>
      <li>
        <a href="book_list_type.php?<?php
      ...
      <li>
        <!-- 跳转到某页 -->
        <form name="form1" class="jump_form" role="form" method="post" action="book_list_type.php?id=<?php echo $id;?>">
